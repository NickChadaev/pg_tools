  ...
  $$
    ...
    BEGIN   
            INSERT INTO gar_fias.gap_adr_area AS z (            
             ...
             FROM  gar_fias_pcg_load.f_adr_area_show_data (p_fias_guid, p_date, p_obj_level, p_qty) x 
...
ALTER FUNCTION gar_fias_pcg_load.f_adr_area_set_data (uuid, date, bigint, integer, text) OWNER TO postgres;  

COMMENT ON FUNCTION gar_fias_pcg_load.f_adr_area_set_data (uuid, date, bigint, integer, text) 
