...
-- +++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
DROP FUNCTION IF EXISTS gar_link.f_show_tbv_descr ( text, char[], text );
CREATE OR REPLACE FUNCTION gar_link.f_show_tbv_descr  
	 (
...
COMMENT ON FUNCTION gar_link.f_show_tbv_descr ( text, char[], text ) IS 'Получение описание таблицы/представления
...
';
-- ----------------------------------------------------------
-- SELECT * FROM f_show_tbv_descr ( 'traffic_face_busin_stat_var', ARRAY['r','v','p']);
