DROP FUNCTION IF EXISTS auth_serv_obj.auth_f_table_privileges_3 (public.t_sysname);
CREATE OR REPLACE FUNCTION auth_serv_obj.auth_f_table_privileges_3 (
...
COMMENT ON FUNCTION auth_serv_obj.auth_f_table_privileges_3 ( public.t_sysname ) 
 IS '114: Отображение эффективных привелегий роли для таблиц.
...
Выходные параметры:
    ...
    3) ,tablename       public.t_text       -- Имя таблицы
...
';  
--- SELECT * FROM auth_serv_obj.auth_f_table_privileges_3('almaz20');
