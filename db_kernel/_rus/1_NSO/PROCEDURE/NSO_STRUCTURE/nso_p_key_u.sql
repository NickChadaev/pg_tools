...
--------------------------------------------------------------------------------------------------------------------- */
DROP FUNCTION IF EXISTS nso_structure.nso_p_key_u (public.id_t, public.t_str60, public.t_arr_code, public.t_boolean);
...
-- ---------------------------------------------------------------------------------------------------------------------
--  2020-01-16 Перегрузка, удаление по ключу
-- =====================================================================================================================
 
   DECLARE
        _key_id             public.id_t; -- ID/маркера ключа
        ...
        --
        _key_code      public.t_str60;   -- Код /маркера ключа
...
COMMENT ON FUNCTION nso_structure.nso_p_key_u (public.id_t, public.t_str60, public.t_arr_code, public.t_boolean)
