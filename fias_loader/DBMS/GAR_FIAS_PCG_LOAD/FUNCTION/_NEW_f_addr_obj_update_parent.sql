DROP FUNCTION IF EXISTS gar_fias_pcg_load."_NEW_f_addr_obj_update_parent" (uuid, uuid, date);
CREATE OR REPLACE FUNCTION gar_fias_pcg_load."_NEW_f_addr_obj_update_parent" (
...
ALTER FUNCTION gar_fias_pcg_load."_NEW_f_addr_obj_update_parent" (uuid, uuid, date) OWNER TO postgres;

COMMENT ON FUNCTION gar_fias_pcg_load."_NEW_f_addr_obj_update_parent" (uuid, uuid, date) 
