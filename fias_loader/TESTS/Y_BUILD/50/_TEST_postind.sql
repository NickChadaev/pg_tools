...
SELECT * FROM gar_tmp.adr_house WHERE (id_area = 200126);
--------------------------------------------------------
SELECT count(1),nm_zipcode FROM gar_tmp.adr_house
WHERE (id_area = 200126) GROUP BY nm_zipcode ORDER BY 1;
----------------------------------------------------------
-- count    nm_zipcode
--    1         142181
--   13          NULL
...
SELECT a.*, h.* FROM gar_tmp.adr_area a
    JOIN gar_tmp.adr_area_hist h ON (a.id_area = h.id_area)
WHERE (a.id_area = 200126 ) ORDER BY 3;
