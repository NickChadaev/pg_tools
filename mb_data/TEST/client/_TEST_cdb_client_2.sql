...
SELECT count(1), id_entity FROM contacts.cm_contact GROUP BY id_entity;-- 615583 rows affected.
SELECT count(1), id_jur_contact FROM contacts.cm_contact GROUP BY id_jur_contact;--  2802191	
SELECT count(1) FROM contacts.cm_contact;  --  2802191

SELECT count(1), kd_entity FROM contacts.cm_contact GROUP BY kd_entity;
-----------------------------------------------------------------------
"count","kd_entity"
-------------------
-- "2"      ,2
...
select * from  metamodel.m_entity order by 1;

SELECT * FROM contacts.cm_contact WHERE kd_entity = 2002
---------------------------------------------------------          
SELECT DISTINCT
                 cc.id_client
                ,cc.id_client_united  
