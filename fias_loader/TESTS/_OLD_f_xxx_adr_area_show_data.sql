-- FUNCTION: gar_tmp_pcg_trans."_OLD_f_xxx_adr_area_show_data"(date, bigint, bigint[])

DROP FUNCTION IF EXISTS gar_tmp_pcg_trans."_OLD_f_xxx_adr_area_show_data"(date, bigint, bigint[]);
CREATE OR REPLACE FUNCTION gar_tmp_pcg_trans."_OLD_f_xxx_adr_area_show_data"(
	p_date date DEFAULT CURRENT_DATE,
	p_obj_level bigint DEFAULT 10,
	p_oper_type_ids bigint[] DEFAULT NULL::bigint[])
...
ALTER FUNCTION gar_tmp_pcg_trans."_OLD_f_xxx_adr_area_show_data"(date, bigint, bigint[])
    OWNER TO postgres;

COMMENT ON FUNCTION gar_tmp_pcg_trans."_OLD_f_xxx_adr_area_show_data"(date, bigint, bigint[])
    IS 'Функция подготавливает исходные данные для таблицы-прототипа "gar_tmp.xxx_adr_area"';
	-----------------------------------------------------------------------------------------
-- SELECT * FROM gar_tmp_pcg_trans."_OLD_f_xxx_adr_area_show_data"() -- 3707
