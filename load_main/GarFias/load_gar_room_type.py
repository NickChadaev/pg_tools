...
CALL_PROC = """CALL gar_fias_pcg_load.save_room_type (
...
# 2022-05-25
BSIZE = 500
MESS_ABOUT = "gar_fias.as_room_type: "

# ------------------------------------------------------------------------------

class RoomTypeHandler( xml.sax.ContentHandler ):
   """
   ...
   def startElement(self, tag, attributes):
      ...
      if tag == "ROOMTYPE":
         ...
         #
         try:
              self.cur_x.execute (CALL_PROC, (self.id, self.type_name, self.short_name, self.type_desc,\
...
class MakeLoad ():
 ...
 def ToDo ( self, p_host_ip, p_port, p_db_name, p_user_name, p_gar_file_path):
    ...
    # -- Handler
    Handler = RoomTypeHandler (self.conn_x, self.cur_x, 0)
