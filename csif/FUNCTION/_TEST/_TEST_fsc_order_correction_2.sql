...
-- ---------------------------------------------------------------------------------------
 ...
 SELECT fsc_receipt_pcg.fsc_order_crt (
     ...
     , p_correction_info  :=  fsc_receipt_pcg.fsc_correction_info_crt_1 ('self', '2023-05-23', '5037008735/22')  
                          -- Вызовет ошибку -- NULL    -- Информация о типе коррекции ОПЦИОНАЛЬНО МОЖЕТ БЫТЬ "NULL"
      -- Покупатель / клиент
