...
DO
 $$
   ...
   BEGIN
    ...
    FROM fsc_receipt_pcg.f_org_cash_get (  p_org_inn := '3650004897'
                                          ,p_id_fsc_provider := 2
    ) INTO __org_cash;      
    --
    ...
    __order := fsc_orange_pcg.fsc_order_corr_crt (
       p_external_id := '18d7ba91-7f0f-4ae9-89ce-f5ee39761d0a'::text -- Внешний идентификатолр документа 
      ,p_inn         := '3650004897'::text         -- ИНН организации, для которой пробивается чек
    ...
    INSERT INTO fiscalization.fsc_receipt (
             ...
             VALUES ( '2024-09-18 10:09:41'
                     , 0
                     , '3650004897'
                     , '18d7ba91-7f0f-4ae9-89ce-f5ee39761d0a'
                     , 85
                     , __order
                     , 2
                     , 1
 ...
 $$;
    SELECT * FROM fiscalization.fsc_receipt 
                   WHERE (rcp_status = 0) AND (rcp_nmb = '18d7ba91-7f0f-4ae9-89ce-f5ee39761d0a');
				   
-- NOTICE:  {"correctionType":0,"type":3,"causeDocumentDate":"2023-08-23T00:00:00","causeDocumentNumber":"XXXX","totalSum":331.45,"cashSum":90.00,"eCashSum":10.00,"prepaymentSum":0.00,"postpaymentSum":0.00,"otherPaymentTypeSum":0.00,"tax1Sum":0.00,"tax2Sum":0.00,"tax3Sum":0.00,"tax4Sum":0.00,"tax5Sum":0.00,"tax6Sum":0.00,"taxationSystem":0}
-- NOTICE:  (40,27,3010071,"{""tax"": ""1"", ""prType"": ""1"", ""agentType"": ""0"", ""paymentType"": ""2"", ""supplierINN"": null, ""provaider_key"": ""3010071"", ""taxationSystem"": ""0"", ""paymentMethodType"": ""4"", ""paymentOperatorINN"": null, ""paymentSubjectType"": ""4"", ""paymentOperatorName"": null, ""supplierPhoneNumbers"": null, ""paymentAgentOperation"": null, ""paymentOperatorAddress"": null, ""paymentAgentPhoneNumbers"": null, ""paymentOperatorPhoneNumbers"": null, ""paymentTransferOperatorPhoneNumbers"": null}")
-- NOTICE:  {"id": "18d7ba91-7f0f-4ae9-89ce-f5ee39761d0a", "inn": "3650004897", "key": "3010071", "group": "3010071", "content": {"type": 3, "cashSum": 90.00, "tax1Sum": 0.00, "tax2Sum": 0.00, "tax3Sum": 0.00, "tax4Sum": 0.00, "tax5Sum": 0.00, "tax6Sum": 0.00, "eCashSum": 10.00, "totalSum": 331.45, "prepaymentSum": 0.00, "correctionType": 0, "postpaymentSum": 0.00, "taxationSystem": 0, "causeDocumentDate": "2023-08-23T00:00:00", "causeDocumentNumber": "XXXX", "otherPaymentTypeSum": 0.00}}
-- DO
