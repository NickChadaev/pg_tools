DROP FUNCTION IF EXISTS auth.auth_f_table_privileges (public.t_sysname);
DROP FUNCTION IF EXISTS auth_serv_obj.auth_f_table_privileges (public.t_sysname);

DROP FUNCTION IF EXISTS auth_f_table_privileges ( varchar(120) );
CREATE OR REPLACE FUNCTION auth_f_table_privileges (
...
COMMENT ON FUNCTION auth_f_table_privileges ( varchar(120) ) 
