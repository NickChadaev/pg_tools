CREATE SCHEMA clientdb AUTHORIZATION mb_owner;

ALTER SCHEMA clientdb
  OWNER TO mb_owner;
...
COMMENT ON TABLE clientdb.cdb_client
IS 'Клиент';
...
IS 'ИД объединенного клиента. Заполнена только у записей, которые объединили в рамках операции объединения дублей. Это ссылка на созданную при объединении запись.';
...
ALTER TABLE clientdb.cdb_client
  OWNER TO mb_owner;
...
ALTER TABLE clientdb.cdb_client_additional
  OWNER TO mb_owner;
...
ALTER TABLE clientdb.cdb_client_journal
  OWNER TO mb_owner;