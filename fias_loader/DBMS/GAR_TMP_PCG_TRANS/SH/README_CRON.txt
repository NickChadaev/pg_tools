...
-----------------    целевая папка "/tmp"?, архив "up_prds_20230206.tar.gz", 
      ...
      В обычном состоянии он содержит перечень обрботанных файлов с региональными обновлениями 
...
Создать папку для размещения log-файла.
