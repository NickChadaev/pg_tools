...
public class X1 extends JFrame implements ActionListener, SwingConstants, FocusListener, KeyListener, 
 ...
 DefaultMutableTreeNode top, category1, globalLeaf; //  Nodos del Arbol de conexiï¿½n
 DefaultMutableTreeNode localLeaf_1, localLeaf_2 ;  //  Was added 2009/07/02  Nick
 
 JTree       tree;		  //HostTree de la estructura de la conexiï¿½n a PostgreSQL
 JTabbedPane tabbedPane;  //Carpetas donde se desplegarï¿½ la informaciï¿½n de tables, datos y queries
  ...
  * Arma y ensambla los elementos de la interfaz grï¿½fica
  */
 public X1() {		
  ...
  //Leer del archivo de configuraciï¿½n el idioma actual
  xlanguage = readLang.getIdiom();
  
  //Si actualmente no se guarda ningï¿½n idioma
  ...
  setJMenuBar   ( menuX );      // Aï¿½adiendo el menu desplegable al Frame
  ...
  //Crear un scroll pane y aï¿½ade el arbol a este 
  treeView = new JScrollPane(tree);  

  //Crear el split pane aï¿½adiendo a la izq. el arbol y a la derecha las pestaï¿½as 
  ...
  //Dar el tamaï¿½o mï¿½nimo para los dos componentes del split pane
  ...
  splitPpal.setDividerLocation ( cSPLIT_VERT_DIV_LOC );  // 270, 135 Selecciona u obtiene la posiciï¿½n actual del divisor.   
  splitPpal.setPreferredSize ( new Dimension ( cSPLIT_PREF_W, cSPLIT_PREF_H )); // 100, 400, 200, 400 Tamaï¿½o preferido para el split pane
  ...
  //Aï¿½ade al panel Global al norte la barra de iconos y en el centro el split
  ...
  getContentPane().add ( "Center", Global );//Aï¿½ade al Frame ppal el panel Global
  
  pack ();

  this.setSize ( sWidth, sHeigth ) ;  // 1024,  768   680, 600 Tamaï¿½o inicial del Frame !!! Nick 2009-11-19
 ...
 public void CreateMenu () {
  ...
  connection = new JMenu (idiom.getWord ("CONNEC"));    //Crea el menu de conexiï¿½n
...
/*    cGroup.pack();
 ...
 public void keyPressed ( KeyEvent e) {
   ...
   String keySelected = KeyEvent.getKeyText ( keyCode ); //cadena que describe la tecla fï¿½sica presionada

   if ( keySelected.equals ( "Delete" ) ) {  //si la tecla presionada es delete 

       if ( DBComponentType == 0 ) { // Presionï¿½ sobre la raiz del arbol de conexiï¿½n, el Servidor   
 ...
 */
 ...
 /**
  * Mï¿½todo writeFile 
  * Sobre escribe el archivo de configuraciï¿½n 
...
/****************************************************************************
 ...
 // --------               
  ...
  // tree.setSelectionRow ( index + 1 ); 
   ...
   activeToolBar ( true );
   switchJMenus ( true ); //encender los botones requeridos cuando la conexiï¿½n es exitosa
 ...
 *************************************************************/ 
  ...
  * Crea un nuevo objeto X1 que inicializa la aplicaciï¿½n
  */
