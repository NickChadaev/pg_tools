...
# FILE: load_gar_apartments_params.py
...
CALL_PROC = """CALL gar_fias_pcg_load.save_gar_apartments_params (
...
# 2022-05-25
BSIZE = 500
MESS_ABOUT = "gar_fias.as_apartments_params: "

# ------------------------------------------------------------------------------

class ApartmentParamsHandler( xml.sax.ContentHandler ):
   """
...
class MakeLoad ():
 ...
 def ToDo ( self, p_host_ip, p_port, p_db_name, p_user_name, p_gar_file_path):
    ...
    Handler = ApartmentParamsHandler (self.conn_x, self.cur_x, 0)
