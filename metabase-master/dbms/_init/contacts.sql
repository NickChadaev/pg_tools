CREATE SCHEMA contacts AUTHORIZATION mb_owner;
...
ALTER TABLE contacts.cm_contact
  OWNER TO mb_owner;
...
ALTER TABLE contacts.cm_contact_status_hist
  OWNER TO mb_owner;
...
ALTER TABLE contacts.cm_service_additional
  OWNER TO mb_owner;
...
ALTER TABLE contacts.cm_service_journal
  OWNER TO mb_owner;
...
ALTER TABLE contacts.cm_service_status_hist
  OWNER TO mb_owner;
...
ALTER TABLE contacts.cm_task_status_hist
  OWNER TO mb_owner;
...
ALTER TABLE contacts.cm_comment
  OWNER TO mb_owner;